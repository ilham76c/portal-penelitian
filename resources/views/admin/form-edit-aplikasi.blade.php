            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form role="form" action='{{ secure_url("/aplikasi/update/{$aplikasi->id}") }}' method="post">
                        @method('PUT')
                        @csrf
                        <!-- /.box -->
                        ...
                        <div class="box">
                            ...
                            <div class="box-body pad">                                        
                                ...
                                <div class="form-group @error('url') has-error @enderror">
                                    ...
                                    <input name="url" type="text" class="form-control" placeholder="URL aplikasi" value="{{ $aplikasi->url }}">
                                    @error('url')
